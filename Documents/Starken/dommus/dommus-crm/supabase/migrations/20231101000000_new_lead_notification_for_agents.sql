-- Atualiza a função que trata os emails de novos leads para incluir notificações para os agentes
...
-- Cria um novo template de email para notificação de agentes sobre novos leads
DO $$
DECLARE
...
-- Verifica e corrige registros incompatíveis antes de modificar a constraint
